...
<div className=' bg-gray-700 text-white mt-1  p-6'>
 ...
 System assigns the ticket a unique ID and categorizes it priority.
  ...
  <div>
     <nav className="grid-rows-3 gap-4 md:place-self-center md:justify-self-end">
    <a>
      <svg
...
<div className="bg-gray-700 items-center p-4 w-full">
  

    < p className='text-white text-center'>© 2025 F-Service. All rights reserved.</p>
